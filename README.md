...
<link rel="icon" type="x-icon" href="CoST.jpg">
</head>
<head>
  ...
  marquee img{
   margin-right: 10px;vertical-align:middle;max-height:40px;
  }
  marquee span{
...
</head><abbr title=""></abbr>
<body>
  <marquee behavior="scroll" direction="left" scrollamount="5">
    <img src="cost1.jpg" width="100" height="50" alt="UC Logo" />
  ...
  <img src="5.jpg" height="300" width="400" /> <br />
